...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        mergeSort(array);
        fio.println(numberOfInversions);
        fio.close();
    }
    // Standard merge sort routine which also updates the number of inversions in the array
        ...
        if (array.length > 1) {
            ...
            while (leftIndex < leftArray.length && rightIndex < rightArray.length) {
                if (leftArray[leftIndex] <= rightArray[rightIndex]) {
                    ...
                    rightIndex++;
                    // Update number of inversions when number in right array > number in left array
